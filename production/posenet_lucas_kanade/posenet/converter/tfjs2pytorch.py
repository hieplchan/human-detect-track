...
from posenet_lucas_kanade.posenet import MobileNetV1, MOBILENET_V1_CHECKPOINTS
...
def load_variables(chkpoint, base_dir=POSENET_MODEL_DIR):
    ...
    if not os.path.exists(manifest_path):
        ...
        from posenet_lucas_kanade.posenet.converter.wget import download
