...
#Video load for test
cap = cv2.VideoCapture('/home/hiep/Tracking_CCTV/CCTV_Data/Video/1.mp4')

# Posenet model setting and load
posenet.MODEL_PATH = '/home/hiep/Tracking_CCTV/production/posenet_package_raspberry/posenet/_models/mobilenet_v1_050.pth'
